...
// MotivasiModel motivasiModelFromJson(String str) =>
//     MotivasiModel.fromJson(json.decode(str));

// String motivasiModelToJson(MotivasiModel data) => json.encode(data.toJson());
